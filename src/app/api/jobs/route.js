// SAFE VERSION - Revert your api/jobs/route.js to this working version:
...
export async function POST(req) {
  try {
    ...
    // Create job - keep it simple, working version
    const job = await Job.create({
      ...
      date: date ? new Date(date) : null, // Keep using date field as before
